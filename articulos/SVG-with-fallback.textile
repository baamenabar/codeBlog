title: En la práctica: ¿Se puede SVG en el DOM? Si, podemos.
subtitle: Nuestra respuesta, durante mucho tiempo, había sido: NO, porque IE y Android no lo ven, se podía en CSS como una mejora de CSS. Pero estábamos equivocados.
...
Por favor, si te sirve esto, coméntame cómo lo quieres usar o lo has usado o si se he escrito puras cabezas de pescado.
