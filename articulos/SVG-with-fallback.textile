...
Como muchos logos ni siquiera tienen gradientes, son muy buenos candidatos para ser puestos como SVG en los sitios web, pero como no conocíamos una manera de incrustar SVG con confianza, pues no lo hacíamos. Según "HTML5 please":http://html5please.com/ y "Can I use":http://caniuse.com/#feat=svg-img SVG tiene bastante buen soporte, pero IE 8, FF 3.6 y el navegador de "Android 2.3(Notas sobre soporte para Android)":#ac7 no tienen soporte. Resulta que en Chile, Internet Explorer 8 o menor, aún es una gran parte de los navegadores usados, particularmente en oficinas.
...
p(#ac7). *EDIT:* Hice pruebas en un Galaxy SII (con Gingerbread) y resulta que no sólo el navegador de Android no tiene soporte en ese teléfono, Firefox para Android, Opera mobile y Dolphin fallaron las pruebas, lo que me hace pensar que es un problema del sistema operativo. Ya haré más pruebas de soporte.
