title: In practice: ¿Can SVG be used as an img with a fallback?
subtitle: Our answer was for a while had been NO, beacuse IE and Android have trouble with it; one can use it only as an enhancement on the styles. But we were wrong. We just need a bit of Modernizr.
classes: language-markup
draft: true
pubDate:2012-10-31 18:37:45

 <header><hgroup> 

h1. En la práctica: ¿Se puede usar SVG confiablemente como imagen?

h2. Claro que si! Usando una combinación de __noscript__, Modernizr y CSS.
</hgroup></header>

h2(#ac1). Preamble

"Skip to the meat":#ac2
...
h3. Observación en Firefox

En Firefox los fondos en SVG al parecer son convertidos a bitmap y no son re-calculados cuando uno hace zoom *(button)Ctrl* + *(button)+* en la página, por lo que para ese uso no tiene mucho sentido usar SVG, traté de corregirlo cambiando las unidades de medida de px a em, pero nada. Esto no ocurre si usamos una imagen directamente.

h3. Problema en Opera
