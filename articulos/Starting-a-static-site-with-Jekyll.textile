...
startedAt: 2013-10-17 12:34:08 GMT
pubDate:2013-10-17 13:37:08 GMT
draft:true
...
p(intro). I have to make my resume, the first impulse was Markdown on GitHub... hmmmm ...now I have the excuse to try out Jekyll. The idea is to make my personal site, with it's domain and a small portfolio, run from Jekyll using GitHub pages. Let's get on with it.
...
Now we run @jekyll serve@ ... Ok, now it's working with proper encoding. Still, that's no fun, I want to write in Markdown and get html output. For that we need the @_layouts@ folder and a layout template in it.

h3. Enter Liquid

The first time I read _“templating engine”_ I ran away, only came back after months. But it's as friendly as starting with LESS or SASS.