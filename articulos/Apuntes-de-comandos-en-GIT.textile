...
h3(#ac6). Eliminar todos los cambios desde el último commit
...
h3(#ac7). Eliminar todos los archivos nuevos desde el último commit
...
h3(#ac8). Volver a un commit anterior
...
h3(#ac10). @Add, commit y push@ en una línea
...
h4(#ac11). @alias@ Más conveniente aún
...
h3(#ac12). Revisar detalle de los cambios
